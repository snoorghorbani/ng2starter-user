...
var feature_3 = require("./feature");
var UserModule = /** @class */ (function () {
    function UserModule() {
    }
    UserModule.forRoot = function (config) {
        return {
    ...
    UserModule.decorators = [
        { type: core_1.NgModule, args: [{
                    ...
                    declarations: [
                        ...
                        feature_3.FeatureContainerComponent,
        ...
        { type: core_1.NgModule, args: [{
                    imports: [
                        ...
                        effects_1.EffectsModule.forFeature([
                            ...
                            feature_2.UserEffects
                        ]),
                        user_routing_module_1.RoutingModule
                    ]
                },] },
    ];
    /** @nocollapse */
    RootUserModule.ctorParameters = function () { return []; };
