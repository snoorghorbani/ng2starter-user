...
var ChangePasswordEffects = /** @class */ (function () {
    function ChangePasswordEffects(actions$, router, passwordService) {
        ...
        this.ChangePasswordRequest$ = this.actions$
            ...
            .pipe(operators_1.map(function (action) { return action.payload; }), operators_1.map(function (data) { return new change_password_actions_1.ChangePasswordStart(data); }));
