...
var authReducer = require("@soushians/authentication");
...
var DashboardContainerComponent = /** @class */ (function () {
    ...
    function DashboardContainerComponent(store, signinService) {
        this.store = store;
