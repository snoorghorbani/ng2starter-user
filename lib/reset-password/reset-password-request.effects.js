...
var ResetPasswordRequestEffects = /** @class */ (function () {
    function ResetPasswordRequestEffects(actions$, router, passwordService) {
        ...
        // switchMap((data: ResetPasswordRequestModel.Request) => this.passwordService.isValidResetPasswordRequest()),
        // map((isValid: boolean) => isValid ? new ResetPasswordLinkRequestStart(data) : new MaximumTryHappend())
        operators_1.map(function (data) { return new reset_password_request_actions_1.ResetPasswordLinkRequestStart(data); }));
        this.MaximumTryHappend$ = this.actions$
            ...
            .pipe(operators_1.map(function () { return new reset_password_request_actions_1.DisableGetLink(); }));
        this.enableAfterTime$ = this.actions$
            ...
            .pipe(operators_1.takeUntil(this.actions$.ofType(reset_password_request_actions_1.ResetPasswordRequestActionTypes.MAXIMUM_TRY_HAPPEND)), operators_1.delay(3 * 1000), operators_1.map(function () { return new reset_password_request_actions_1.EnableGetLink(); }));
        this.RequestResetPasswordLink$ = this.actions$
            ...
            .pipe(operators_1.map(function (action) { return action.payload; }), operators_1.switchMap(function (data) { return _this.passwordService.requestResetPasswordLink(data); }), operators_1.map(function () { return new reset_password_request_actions_1.ResetPasswordLinkRequestSucceed(); }), operators_1.catchError(function () { return Observable_1.Observable.of(new reset_password_request_actions_1.ResetPasswordLinkRequestFailed()); }));
    }
